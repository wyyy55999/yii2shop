...
<div class="logo w1210">
    ...
    <div class="search fl">
        <div class="search_form">
            ...
            <form method="get" class="fl" action="<?=\yii\helpers\Url::to(['/goods/list'])?>">
                <input type="text" class="txt" value="请输入商品关键字" name="keywords" id="search_input"/><input type="submit" class="btn" value="搜索" id="search_button" />
            </form>
...
<div class="colligate w1210 bc mt10">
    ...
    <div style="clear:both;"></div>
<?php
//$url = \yii\helpers\Url::to(['/goods/list']);
$this->registerJs(new \yii\web\JsExpression(
    <<<JS
    $('#search_button').click(function() {
        var keywords = $('#search_input').val();
        /*$.get('',{'keywords':keywords},function(response) {
