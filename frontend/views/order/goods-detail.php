...
<div class="main w1210 bc mt10">
    ...
    <div class="menu fl">
        ...
        <div class="menu_wrap">
            <dl>
                <dt>订单中心 <b></b></dt>
                <dd class="cur"><b>.</b><?php
                    if(Yii::$app->user->isGuest){
                        echo '我的订单';
                    }else{
                        echo \yii\helpers\Html::a('我的订单',['order/detail']);
                    }
                    ?>
                </dd>
    ...
    <div class="content fl ml10">
        ...
        <div class="order_bd mt10">
            <table class="orders">
                ...
                <tbody>
                <?php foreach ($order_goods as $order_goods):?>
                    <tr>
                        <td><?=\backend\models\Goods::findOne(['id'=>$order_goods->goods_id])->sn?></td>
                        <td><?=$order_goods->goods_name?></td>
                        <td><?=\yii\helpers\Html::img('http://admin.yii2shop.com'.$order_goods->logo)?></td>
                        <td><?=$order_goods->price?></td>
                        <td><?=$order_goods->amount?></td>
