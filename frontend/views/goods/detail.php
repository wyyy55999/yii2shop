    ...
    <div class="goods_content fl mt10 ml10">
        ...
        <div class="summary">
            ...
            <div class="preview fl">
                <div class="midpic">
                    <a href="http://admin.yii2shop.com<?=$goods_albums[0]->album_path?>" class="jqzoom" rel="gal1">   <!-- 第一幅图片的大图 class 和 rel属性不能更改 -->
                        <?=\yii\helpers\Html::img('http://admin.yii2shop.com'.$goods_albums[0]->album_path,[
